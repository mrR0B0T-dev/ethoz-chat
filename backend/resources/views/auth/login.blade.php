...
<head>
  ...
  <style>
    ...
    :root{
      --navy:#062A52; --blue:#0F5AA8; --azure:#1E7BD6; --accent:#2E90E4;
      --sky:#63BDF5; --ink:#0A1A2B; --muted:#6B7E92;
    }
    *{box-sizing:border-box}
    body{margin:0;min-height:100vh;display:flex;align-items:center;justify-content:center;
      padding:24px;background:linear-gradient(165deg,#E8F2FD,#F2F8FE 55%,#E9F1FB);
      font-family:'Inter',system-ui,sans-serif;color:var(--ink)}
    .card{width:100%;max-width:380px;background:#fff;border-radius:18px;padding:26px;
      border:1px solid rgba(6,42,82,.06);box-shadow:0 6px 18px rgba(6,42,82,.05)}
    .brand{display:flex;align-items:center;gap:10px;margin-bottom:18px}
    .brand .dot{width:38px;height:38px;border-radius:11px;display:flex;align-items:center;
      justify-content:center;background:linear-gradient(135deg,#63BDF5,#2E90E4);font-size:19px}
    ...
    .in{width:100%;font-family:'Inter',sans-serif;font-size:13.5px;color:var(--ink);
      padding:10px 12px;border-radius:11px;border:1px solid #D7E3F2;outline:none;background:#fff}
    .in:focus{border-color:var(--accent);box-shadow:0 0 0 3px rgba(46,144,228,.15)}
